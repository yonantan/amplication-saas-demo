...
describe("OrganizationMembership", () => {
  ...
  test("POST /organization-memberships", async () => {
  ...
  test("GET /organization-memberships", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /organization-memberships/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/organization-memberships"}/${nonExistingId}`)
      .expect(404)
      .expect({
        statusCode: 404,
  ...
  test("GET /organization-memberships/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/organization-memberships"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
